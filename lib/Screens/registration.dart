                  ...
                  key: _formKey,
                    ...
                    children: <Widget>[
                      TextFormField(
                        ...
                        hintStyle: TextStyle( color: Colors.black87, fontSize: 20.0),
                        filled: true,
                        fillColor: Colors.blue[100],
                        prefixIcon: Icon(Icons.person_pin, color:Colors.blue, size: 40.0),
                      ...
                      TextFormField(
                        ...
                        filled: true,
                        fillColor: Colors.blue[100],
                        prefixIcon: Icon(Icons.phone,color:Colors.blue, size: 40.0),
                        ...
                        builder: (context, snapshot){
                          if(!snapshot.hasData){
                            ...
                            for( int i = 0; i < snapshot.data.documents.length; i++){
                              DocumentSnapshot type = snapshot.data.documents[i];
                              category.add(
                                DropdownMenuItem(
                                  child: Text(
                                    type.documentID,
                                  ...
                                  DropdownButton(
                                    ...
                                    onChanged: (category){
                                      ...
                                      final snackBar = SnackBar(
                                        content: Text('Selected Category is $laborCategory',
